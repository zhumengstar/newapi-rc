...
type Log struct {
	...
	CreatedAt         int64  `json:"created_at" gorm:"bigint;index:idx_created_at_id,priority:1;index:idx_created_at_type;index:idx_channel_type_created_at,priority:3"`
	Type              int    `json:"type" gorm:"index:idx_created_at_type;index:idx_channel_type_created_at,priority:2"`
	...
	ChannelId         int    `json:"channel" gorm:"index;index:idx_channel_type_created_at,priority:1"`
