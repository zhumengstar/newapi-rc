...
const TYPE_LABEL: Record<string, string> = {
  ...
  adaptive_routing: 'Adaptive channel routing',
  channel_balance: 'Channel balance refresh',
  channel_error_guard: 'Channel error protection',
  channel_recovery: 'Channel recovery',
  channel_health_check: 'Channel health check',
  priority_normalize: 'Channel priority normalization',
}
