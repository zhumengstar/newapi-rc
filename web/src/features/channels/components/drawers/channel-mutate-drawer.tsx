...
export function ChannelMutateDrawer({
  ...
  const currentOther = formValues.other
  ...
  const currentAdaptiveEnabled = formValues.adaptive_enabled
  const currentTag = formValues.tag
  const currentRemark = formValues.remark
  const currentStatusCodeMapping = formValues.status_code_mapping
  const currentParamOverride = formValues.param_override
  const currentHeaderOverride = formValues.header_override
  const currentForceFormat = formValues.force_format
  const currentThinkingToContent = formValues.thinking_to_content
  const currentPassThroughBodyEnabled = formValues.pass_through_body_enabled
  const currentDisableTaskPollingSleep =
    formValues.disable_task_polling_sleep
  const currentProxy = formValues.proxy
  const currentHttpProtocol = formValues.http_protocol
  const currentHttp2ConnectionShards = formValues.http2_connection_shards
  const currentSystemPrompt = formValues.system_prompt
  const currentSystemPromptOverride = formValues.system_prompt_override
  const currentAllowServiceTier = formValues.allow_service_tier
  const currentDisableStore = formValues.disable_store
  const currentAllowSafetyIdentifier = formValues.allow_safety_identifier
  const currentAllowIncludeObfuscation =
    formValues.allow_include_obfuscation
  const currentAllowInferenceGeo = formValues.allow_inference_geo
  const currentAllowSpeed = formValues.allow_speed
  const currentClaudeBetaQuery = formValues.claude_beta_query
  const currentUpstreamModelUpdateAutoSyncEnabled =
    formValues.upstream_model_update_auto_sync_enabled
  const currentUpstreamModelUpdateIgnoredModels =
    formValues.upstream_model_update_ignored_models
      ...
      <div className='space-y-4 rounded-lg border p-4'>
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='flex items-center justify-between'>
              <div className='space-y-0.5'>
                <FormLabel>{t('Adaptive Routing')}</FormLabel>
                <FormDescription>
                  {t(FIELD_DESCRIPTIONS.ADAPTIVE_ENABLED)}
                </FormDescription>
              </div>
              <FormControl>
                <Switch
        ...
        {currentAdaptiveEnabled && (
          <div className='grid gap-4 sm:grid-cols-2 pt-2 border-t'>
            <FormField
              control={form.control}
              name='adaptive_window_seconds'
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Window Size (seconds)')}</FormLabel>
                  <FormControl>
                    <Input
                      type='number'
                      min={10}
                  ...
                  <FormDescription>
                    {t(FIELD_DESCRIPTIONS.ADAPTIVE_WINDOW_SECONDS)}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {t(FIELD_DESCRIPTIONS.ADAPTIVE_MIN_SAMPLES)}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              control={form.control}
              name='adaptive_slow_threshold_ms'
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Slow Threshold (ms)')}</FormLabel>
                  <FormControl>
                    <Input
                      type='number'
                      min={100}
                  ...
                  <FormDescription>
                    {t(FIELD_DESCRIPTIONS.ADAPTIVE_SLOW_THRESHOLD)}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              control={form.control}
              name='adaptive_min_weight'
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Minimum Weight')}</FormLabel>
                  <FormControl>
                    <Input
                      type='number'
                      min={1}
                  ...
                  <FormDescription>
                    {t(FIELD_DESCRIPTIONS.ADAPTIVE_MIN_WEIGHT)}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              control={form.control}
              name='adaptive_max_weight'
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Maximum Weight')}</FormLabel>
                  <FormControl>
                    <Input
                      type='number'
                      min={1}
                  ...
                  <FormDescription>
                    {t(FIELD_DESCRIPTIONS.ADAPTIVE_MAX_WEIGHT)}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              control={form.control}
              name='adaptive_recovery_weight'
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Recovery Weight')}</FormLabel>
                  <FormControl>
                    <Input
                      type='number'
                      min={1}
                  ...
                  <FormDescription>
                    {t(FIELD_DESCRIPTIONS.ADAPTIVE_RECOVERY_WEIGHT)}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {t(FIELD_DESCRIPTIONS.ADAPTIVE_COOLDOWN)}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
