...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPut, path: "/:id/adaptive", permission: authz.ChannelWrite, handler: controller.UpdateChannelAdaptiveEnabled},
	{method: http.MethodPut, path: "/group/priority-order", permission: authz.ChannelWrite, handler: controller.ApplyChannelGroupPriorityOrder},
	{method: http.MethodPut, path: "/control_policies", permission: authz.ChannelSensitiveWrite, handler: controller.UpsertChannelControlPolicy},
	{method: http.MethodDelete, path: "/control_policies/:group", permission: authz.ChannelSensitiveWrite, handler: controller.DeleteChannelControlPolicy},
	{method: http.MethodPost, path: "/detect_type", permission: authz.ChannelOperate, handler: controller.DetectChannelType},
	{method: http.MethodPost, path: "/detect_type_all", permission: authz.ChannelOperate, handler: controller.DetectAllChannelTypes},
	...
	{method: http.MethodGet, path: "/:id/balance_settings", permission: authz.ChannelSensitiveWrite, handler: controller.GetChannelBalanceSettings},
	{method: http.MethodPut, path: "/:id/balance", permission: authz.ChannelWrite, handler: controller.SetChannelBalance},
	{method: http.MethodPut, path: "/:id/balance_settings", permission: authz.ChannelSensitiveWrite, handler: controller.UpdateChannelBalanceSettings},
